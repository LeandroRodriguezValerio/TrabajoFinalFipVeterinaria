...
let posicionNombre=this.listaClientes.findIndex(Cliente=>Cliente.getNombre()===nombre1)

if (posicionNombre==-1){
     posicionNombre=this.listaProvedores.findIndex(Proveedor=>Proveedor.getNombre()===nombre1)
    if(posicionNombre==-1){
        posicionNombre=this.listaPacientes.findIndex(Paciente=>Paciente.getNombre()===nombre1)
        if ( posicionNombre==-1){
...
let posicionTelefonoClien=this.listaClientes.findIndex(Cliente=>Cliente.getTelefono()===telefono1)
...
modificarTelefonoProv():void{
    ...
    let posicionTelefonoProv=this.listaProvedores.findIndex(Proveedor=>Proveedor.getTelefono()===telefono1)
